...
export default function SearchPeople() {
    ...
    return (
        <div className="min-h-screen h-auto bg-sky-700 grow">
            <h1 className="p-8 font-bold text-4xl text-white">Search People</h1>
            <div className="mb-5">
                <form className="max-w-lg mx-auto">
                    <div className="flex">
                        ...
                        <div className="relative w-full">
                            <input type="search" id="aad" name="key" onChange={getSearchResult} className="p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-white focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" required />
            ...
            <div className="flex justify-center">
                {(searchresult.length === 0) ? <div className="text-center text-2xl p-8 text-gray-100">No Results Found</div> :<Condition results={searchresult} />}
            </div>
        </div>
    );
}
